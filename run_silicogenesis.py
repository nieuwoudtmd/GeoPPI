...
def main():
    ...
    wildtypefile = sys.argv[1]
    mutantfile = f'{data_dir}/pdb/{pdb_file_unique}'
    ...
    ddg, features = GeoPPIpredict(A,E,A_m,E_m, model, forest, sorted_idx,flag)

    # save embeddings
    features_file = os.path.join(output_embeddings_dir, pdb_unique)
